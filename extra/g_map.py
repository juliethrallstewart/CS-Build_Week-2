# -*- coding: utf-8 -*-
"""Lambda Treasure Hunt - CS BW2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ka8koGD9oW2YpCXJDYoQB4vBM1V-oACN
...
graph = {0: [{'e': 4, 'n': 10, 's': 2, 'w': 1},
 ...
 316: [{'n': 344, 'w': 155},
  ...
  'description': 'You are standing on grass and surrounded by a dense mist. You can barely make out the exits in any direction.', 
  'coordinates': '(58,49)', 'elevation': 0, 'terrain': 'NORMAL', 'players': [], 'items': [], 
  'exits': ['s', 'e', 'w'], 'cooldown': 15.0, 'errors': [], 'messages': ['You have walked west.']}],
  318: [{'n': 281, 's': 487},
  {'room_id': 318, 'title': 'A misty room', 'description': 'You are standing on grass and surrounded by a dense mist. You can barely make out the exits in any direction.', 'coordinates': '(59,48)', 'elevation': 0, 'terrain': 'NORMAL', 'players': [], 'items': [], 
 ...
 325: [{'n': 353, 's': 280, 'w': 374},
  {'cooldown': 15.0,
   ...
   'title': 'A misty room'}],
   326: [{'s': 342, 'w': 309},
  {'room_id': 326, 'title': 'A misty room', 'description': 'You are standing on grass and surrounded by a dense mist. You can barely make out the exits in any direction.', 'coordinates': '(61,49)', 'elevation': 0, 'terrain': 'NORMAL', 'players': [], 'items': [], 
 ...
 332: [{'n': 350, 's': 328},
  {'cooldown': 15.0,
   ...
   'title': 'A misty room'}],
   333: [{'n': 309, 's': 378},
  {'room_id': 333, 'title': 'A misty room', 'description': 'You are standing on grass and surrounded by a dense mist. You can barely make out the exits in any direction.', 'coordinates': '(60,48)', 'elevation': 0, 'terrain': 'NORMAL', 'players': [], 'items': [], 
  'exits': ['n', 's'], 'cooldown': 15.0, 'errors': [], 'messages': ['You have walked south.']}],
 ...
 341: [{'s': 449, 'w': 334},
  {'cooldown': 15.0,
   ...
   'title': 'A misty room'}],
   342: [{'n': 326, 's': 342},
  {'room_id': 342, 'title': 'A misty room', 'description': 'You are standing on grass and surrounded by a dense mist. You can barely make out the exits in any direction.', 'coordinates': '(61,48)', 'elevation': 0, 'terrain': 'NORMAL', 'players': [], 'items': [], 
  'exits': ['n', 's'], 'cooldown': 15.0, 'errors': [], 'messages': ['You have walked south.']}],
 343: [{'s': 273, 'w': 351},
  {'cooldown': 15.0,
   'coordinates': '(53,53)',
 ...
 430: [{'e': 439, 'n': 443, 'w': 427},
  ...
  432: [{'n': 342},
  {'room_id': 432, 'title': 'A misty room', 'description': 'You are standing on grass and surrounded by a dense mist. You can barely make out the exits in any direction.', 'coordinates': '(61,47)', 'elevation': 0, 'terrain': 'NORMAL', 'players': [], 'items': [], 
  'exits': ['n'], 'cooldown': 15.0, 'errors': [], 'messages': ['You have walked south.']}],
 ...
 488: [{'n': 412},
  {'cooldown': 15.0,
   ...
   'title': 'A Dark Cave'}],
   489: [{'n': 487},
  {'room_id': 489, 'title': 'A misty room', 'description': 'You are standing on grass and surrounded by a dense mist. You can barely make out the exits in any direction.', 'coordinates': '(59,46)', 'elevation': 0, 'terrain': 'NORMAL', 'players': [], 'items': [], 
  'exits': ['n'], 'cooldown': 15.0, 'errors': [], 'messages': ['You have walked south.']}],
 490: [{'e': 444, 'w': 493},
  {'cooldown': 15.0,
   'coordinates': '(51,54)',
...
# Set up token
token = open('julie_thrall_stewart.txt', 'r').read()
...
def dash(direction, num_rooms, next_room_ids):
  ...
  data = f'{{"direction":"{direction}","num_rooms":"{num_rooms}","next_room_id":"{next_room_ids}"}}'
  print(data)
  result = requests.post(url, data=data,
                         headers={'Content-Type':'application/json',
                                  'Authorization': f'Token {token}'}).json()
...
# !curl -X POST -H 'Authorization: Token xxxxxxxxxxxxx' -H "Content-Type: application/json" -d '{"direction":"e", "num_rooms":"3", "next_room_ids":"4,13,15"}' https://lambda-treasure-hunt.herokuapp.com/api/adv/dash/
...
- Use gold to change name
- Player can hold up to player's strength stats (10) items
...
Room 467 - Use 1000g to change name to unlock abilities and pray
"""
...
while True:
  ...
  if end_room['title'] == 'Wishing Well':
    time.sleep(end_room['cooldown'])
    end_room = wishing_well()
    destination = msg_decode(end_room['message'])
